...
export default function Navbar() {
  return (
    <motion.nav
      ...
      className="absolute md:fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-background/50 backdrop-blur-md border-b border-white/5"
    >
