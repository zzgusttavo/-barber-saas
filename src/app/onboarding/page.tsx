  ...
  return (
    <main className="min-h-screen bg-background flex flex-col lg:flex-row font-sans selection:bg-primary/30 selection:text-white">
      ...
      <section className="flex-1 flex flex-col bg-[#0a0a0a] relative overflow-y-auto">
        ...
        <div className="flex-1 flex flex-col max-w-2xl w-full mx-auto p-6 md:p-12 lg:p-16 xl:p-24 justify-center min-h-[600px]">
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                {currentStep === 1 && (
                  <div>
                    <div className="text-center mb-10">
                      <h2 className="text-3xl font-black text-white mb-2">Cadastre seu negócio</h2>
                      <p className="text-text-secondary">Bora dar um up na sua gestão.</p>
                    </div>
                    ...
                    <div className="space-y-5">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full bg-card border border-white/10 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all"
                          placeholder="Ex: Gustavo Henrique"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-text-secondary mb-1.5">Celular (WhatsApp)</label>
                        <input 
                          type="text" 
                          name="phone"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-text-secondary mb-1.5">Nome do negócio</label>
                        <input 
                          type="text" 
                          name="businessName"
                ...
                {currentStep === 2 && (
                  <div>
                    <div className="text-center mb-10">
                      <p className="text-primary text-sm font-bold uppercase tracking-wider mb-2">Informações adicionais</p>
                      <h2 className="text-3xl font-black text-white">Tamanho do negócio</h2>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      >
                        <Store size={32} className={formData.businessSize === "unico" ? "text-primary" : "text-white/40"} />
                        <span className="font-bold text-lg">Estabelecimento único</span>
                      </button>
                      ...
                      >
                        <Building2 size={32} className={formData.businessSize === "rede" ? "text-primary" : "text-white/40"} />
                        <span className="font-bold text-lg">Rede ou Franquia</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {currentStep === 3 && (
                  <div>
                    <div className="text-center mb-10">
                      <p className="text-primary text-sm font-bold uppercase tracking-wider mb-2">Informações adicionais</p>
                      <h2 className="text-3xl font-black text-white">Número de profissionais que fazem atendimento em seu negócio</h2>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      {["1 profissional", "2 profissionais", "3 a 4 profissionais", "5 a 10 profissionais", "11 a 30 profissionais", "Mais de 30 profissionais"].map((size) => (
                        <button
                          key={size}
                ...
                {currentStep === 4 && (
                  <div>
                    <div className="text-center mb-10">
                      <p className="text-primary text-sm font-bold uppercase tracking-wider mb-2">Informações adicionais</p>
                      <h2 className="text-3xl font-black text-white">Defina sua senha</h2>
                    </div>

                    <div className="max-w-sm mx-auto">
                      <div className="relative mb-8">
                        <label className="block text-sm font-medium text-text-secondary mb-1.5">Senha de acesso ao painel</label>
                        <div className="relative">
                          <input 
                            ...
                            onChange={handleChange}
                            className="w-full bg-card border border-white/10 rounded-xl pl-11 pr-4 py-4 text-white focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all font-medium tracking-widest"
                            placeholder="••••••••"
                          />
